    ...
    area.innerHTML = `
      <div class="member-auth-logged">
        ...
        <div class="member-auth-dropdown" id="memberMenuDropdown">
          ${profile.is_admin ? '<a href="/admin/">홈페이지 관리</a><a href="/pages/admin-members.html">회원 관리</a><a href="/pages/admin-sermons.html">말씀과 찬양 관리</a><a href="/pages/admin-weekly-word.html">주간말씀 관리</a><a href="/pages/admin-popups.html">홈페이지 팝업 관리</a><a href="/pages/admin-news.html">공지사항·주보 관리</a>' : ''}
