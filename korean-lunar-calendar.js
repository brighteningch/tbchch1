// 한국천문연구원(KASI) 기준 음력-양력 변환 라이브러리
// 출처: usingsky/korean_lunar_calendar_js (MIT License, Copyright (c) 2022 Jinil Lee)
// https://github.com/usingsky/korean_lunar_calendar_js — TypeScript 원본을 순수 JS로 이식
// 재적관리 생일달력에서 음력 생일을 해당 연도의 정확한 양력 날짜로 변환하는 데 사용한다.
...
class KoreanLunarCalendar {
  ...
  cumulativeLunarYearDays = new Map();
  cumulativeSolarYearDays = new Map();
